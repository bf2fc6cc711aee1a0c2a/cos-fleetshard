    ...
    void connectorIsProvisioned() {
        {
            ...
            assertThat(s1).satisfies(item -> {
                assertThat(item.getMetadata().getName()).startsWith("c-").endsWith("-s-" + 1);
            ...
            assertThat(mc.getMetadata().getName()).startsWith("c-");
        ...
        }
        {
            ...
            assertThat(s2).satisfies(item -> {
                assertThat(item.getMetadata().getName()).startsWith("c-").endsWith("-s-" + 2);
