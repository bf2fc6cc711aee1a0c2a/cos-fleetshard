...
* build the https://github.com/bf2fc6cc711aee1a0c2a/cos-fleet-manager-api[cos-fleet-manager-api] project
+
[source,shell]
----
git clone git@github.com:bf2fc6cc711aee1a0c2a/cos-fleet-manager-api.git
./mvnw clean install -f cos-fleet-manager-api-java/pom.xml
----

* Alternatively to building the API artifact yourself, you can obtain it as a dependency;
to do so, add a server section to ~/.m2/settings.xml, like:
+
[source,xml]
----
<server>
