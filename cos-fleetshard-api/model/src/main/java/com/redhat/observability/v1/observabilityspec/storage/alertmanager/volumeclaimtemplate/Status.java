...
public class Status implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<com.redhat.observability.v1.observabilityspec.storage.alertmanager.volumeclaimtemplate.status.Conditions> conditions;

    public java.util.List<com.redhat.observability.v1.observabilityspec.storage.alertmanager.volumeclaimtemplate.status.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(
        java.util.List<com.redhat.observability.v1.observabilityspec.storage.alertmanager.volumeclaimtemplate.status.Conditions> conditions) {
