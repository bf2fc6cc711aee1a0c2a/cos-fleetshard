...
public class Spec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.DataSource dataSource;

    public com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.DataSource getDataSource() {
        return dataSource;
    }

    public void setDataSource(
        com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.DataSource dataSource) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Resources resources;

    public com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Resources getResources() {
        return resources;
    }

    public void setResources(
        com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Resources resources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Selector selector;

    public com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Selector getSelector() {
        return selector;
    }

    public void setSelector(
        com.redhat.observability.v1.observabilityspec.storage.prometheus.volumeclaimtemplate.spec.Selector selector) {
