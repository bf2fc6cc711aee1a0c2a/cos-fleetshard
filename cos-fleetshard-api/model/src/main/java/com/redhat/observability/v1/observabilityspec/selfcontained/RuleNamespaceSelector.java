...
public class RuleNamespaceSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.rulenamespaceselector.MatchExpressions> matchExpressions;

    public java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.rulenamespaceselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
        java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.rulenamespaceselector.MatchExpressions> matchExpressions) {
