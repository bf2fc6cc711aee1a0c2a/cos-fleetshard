...
public class ProbeSelector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.probeselector.MatchExpressions> matchExpressions;

    public java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.probeselector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(
        java.util.List<com.redhat.observability.v1.observabilityspec.selfcontained.probeselector.MatchExpressions> matchExpressions) {
