...
public class Alertmanager implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.redhat.observability.v1.observabilityspec.storage.alertmanager.EmptyDir emptyDir;

    public com.redhat.observability.v1.observabilityspec.storage.alertmanager.EmptyDir getEmptyDir() {
        return emptyDir;
    }

    public void setEmptyDir(com.redhat.observability.v1.observabilityspec.storage.alertmanager.EmptyDir emptyDir) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private com.redhat.observability.v1.observabilityspec.storage.alertmanager.VolumeClaimTemplate volumeClaimTemplate;

    public com.redhat.observability.v1.observabilityspec.storage.alertmanager.VolumeClaimTemplate getVolumeClaimTemplate() {
        return volumeClaimTemplate;
    }

    public void setVolumeClaimTemplate(
        com.redhat.observability.v1.observabilityspec.storage.alertmanager.VolumeClaimTemplate volumeClaimTemplate) {
