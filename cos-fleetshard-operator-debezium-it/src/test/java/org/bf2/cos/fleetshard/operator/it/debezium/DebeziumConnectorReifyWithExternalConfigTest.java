...
@WithKubernetesTestServer(setup = DebeziumConnectorReifyWithExternalConfigTest.Setup.class)
public class DebeziumConnectorReifyWithExternalConfigTest extends CucumberQuarkusTest {
    ...
    public static class Profile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            ...
            return Map.of(
                "cos.namespace", ns,
                "cos.operator.debezium.kafka-connect.config.\"offset.storage.replication.factor\"", "3");
        }
    }
}
