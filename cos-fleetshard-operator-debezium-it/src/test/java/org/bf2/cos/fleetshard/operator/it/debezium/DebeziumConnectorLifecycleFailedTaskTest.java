...
@CucumberOptions(
    features = {
        "classpath:DebeziumConnectorLifecycleFailedTask.feature"
    },
    glue = {
        "org.bf2.cos.fleetshard.it.cucumber",
        "org.bf2.cos.fleetshard.operator.it.debezium.glues"
    })
@TestProfile(DebeziumConnectorLifecycleFailedTaskTest.Profile.class)
@WithKubernetesTestServer(setup = DebeziumConnectorLifecycleFailedTaskTest.Setup.class)
public class DebeziumConnectorLifecycleFailedTaskTest extends CucumberQuarkusTest {
