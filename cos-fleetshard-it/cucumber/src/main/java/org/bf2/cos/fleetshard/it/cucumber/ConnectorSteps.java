...
public class ConnectorSteps {
    ...
    public void deployment_is_in_phase(String phase) {
        untilConnector(c -> {
            System.out.println("######### Desired Phase: " + phase + "; Connector Phase: " + c.getStatus().getConnectorStatus().getPhase() + " // " + c.getStatus().getPhase());
            System.out.println("######### ConnectorStatus Conditions: " + c.getStatus().getConnectorStatus().getConditions());
            return Objects.equals(phase, c.getStatus().getConnectorStatus().getPhase());
        });
    }
