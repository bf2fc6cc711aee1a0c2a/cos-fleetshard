...
@QuarkusTest
@TestProfile(NamespaceProvisionerWithQuotaEmptyTest.Profile.class)
public class NamespaceProvisionerWithQuotaEmptyTest extends NamespaceProvisionerWithNoQuotaTestBase {
