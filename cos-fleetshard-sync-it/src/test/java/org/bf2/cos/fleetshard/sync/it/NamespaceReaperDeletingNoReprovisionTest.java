...
@QuarkusTest
@TestProfile(NamespaceReaperDeletingNoReprovisionTest.Profile.class)
public class NamespaceReaperDeletingNoReprovisionTest extends NamespaceReaperDelNoReprovisionTestBase {
