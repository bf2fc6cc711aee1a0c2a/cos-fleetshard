...
@QuarkusTest
@TestProfile(NamespaceProvisionerWithQuotaNullTest.Profile.class)
public class NamespaceProvisionerWithQuotaNullTest extends NamespaceProvisionerWithNoQuotaTestBase {
