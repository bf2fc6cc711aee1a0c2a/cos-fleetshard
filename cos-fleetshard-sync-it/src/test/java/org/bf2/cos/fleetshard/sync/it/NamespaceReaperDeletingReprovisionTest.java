...
@QuarkusTest
@TestProfile(NamespaceReaperDeletingReprovisionTest.Profile.class)
public class NamespaceReaperDeletingReprovisionTest extends NamespaceReaperDelReprovisionTestBase {
