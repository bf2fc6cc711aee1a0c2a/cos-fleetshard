...
@QuarkusTest
@TestProfile(NamespaceProvisionerBadIdMailTest.Profile.class)
public class NamespaceProvisionerBadIdMailTest extends NamespaceProvisionerBadIdTestBase {

    public static class Profile extends SyncTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of(
                "test.deployment.id.1", "foo@acme.com",
