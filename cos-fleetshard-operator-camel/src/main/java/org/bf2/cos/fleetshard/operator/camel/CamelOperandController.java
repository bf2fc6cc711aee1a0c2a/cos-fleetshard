...
public class CamelOperandController extends AbstractOperandController<CamelShardMetadata, ObjectNode> {
    ...
    protected List<HasMetadata> doReify(
        ...
        final Map<String, String> properties = createSecretsData(connector, shardMetadata, connectorSpec, kafkaSpec,
            new TreeMap<>());
        final List<ProcessorKamelet> stepDefinitions = createSteps(connectorSpec, shardMetadata, properties);
