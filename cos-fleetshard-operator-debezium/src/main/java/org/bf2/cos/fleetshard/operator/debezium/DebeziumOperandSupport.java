...
public class DebeziumOperandSupport {
    ...
    public static void computeConnectorStatus(
        ...
        if (null != kafkaConnector) {
            ...
            if (null != kafkaConnectorStatus) {
                ...
                switch (kafkaConnectorStatus.getState()) {
                    case KafkaConnectorStatus.STATE_UNASSIGNED:
                        ...
                        System.out.println("######### 101 SET STATUS: " + statusSpec.getPhase());
                        return;
                    case KafkaConnectorStatus.STATE_PAUSED:
                        ...
                        System.out.println("######### 102 SET STATUS: " + statusSpec.getPhase());
                        return;
                    default:
                        break;
                }
            ...
            if (connectorStatus.isConnectorReady()) {
                ...
                if (errors.isEmpty()) {
                    ...
                    System.out.println("######### 1 SET STATUS: " + statusSpec.getPhase());
                } else {
                    readyCondition.setType("Ready");
                    readyCondition.setStatus("False");
                    ...
                    System.out.println("######### 2 SET STATUS: " + statusSpec.getPhase());
                }
            } else {
                ...
                statusSpec.setPhase(ManagedConnector.STATE_FAILED);
                System.out.println("######### 3 SET STATUS: " + statusSpec.getPhase());
            }
        }
    }

    public static void computeKafkaConnectStatus(
            ...
            if (connectorStatus.isConnectorReady() && !kafkaConnectReady) {
                if (null != kconnectReadyCondition && !"True".equals(kconnectReadyCondition.getStatus())
                    ...
                    if ("TimeoutException".equals(kconnectNotReadyCondition.getReason())) {
                        io.fabric8.kubernetes.api.model.Condition readyCondition = connectorStatus.getReadyCondition();
                ...
                System.out.println("######### 4 SET STATUS: " + connectorStatus.getStatusSpec().getPhase());
            } else {
                if (null == connectorStatus.getReadyCondition()) {
                    io.fabric8.kubernetes.api.model.Condition readyCondition = new io.fabric8.kubernetes.api.model.Condition();
                    readyCondition.setType("Ready");
                    readyCondition.setStatus("False");
                    ...
                    System.out.println("######### 5 SET STATUS: " + connectorStatus.getStatusSpec().getPhase());
                }
            }
        }
    }
    ...
    public static void computeStatus(ConnectorStatusSpec statusSpec, KafkaConnect kafkaConnect, KafkaConnector connector) {
        ...
        System.out.println("######################################################");
        System.out.println("########## READY CONDITION: " + managedConnectorStatus.getReadyCondition());
        System.out.println("########## STATUS CONDITIONS: " + managedConnectorStatus.getStatusSpecConditions());

        managedConnectorStatus.getStatusSpecConditions().add(managedConnectorStatus.getReadyCondition());
