...
@CucumberOptions(
    features = {
        "classpath:CamelConnectorReifyWithTrait.feature"
    },
    glue = {
        "org.bf2.cos.fleetshard.it.cucumber",
        "org.bf2.cos.fleetshard.operator.it.camel.glues"
    })
@TestProfile(CamelConnectorReifyWithTraitTest.Profile.class)
public class CamelConnectorReifyWithTraitTest extends CucumberQuarkusTest {
