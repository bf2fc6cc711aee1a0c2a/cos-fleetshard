...
@CucumberOptions(
    features = {
        "classpath:CamelConnectorReifyWithDefaults.feature"
    },
    glue = {
        "org.bf2.cos.fleetshard.it.cucumber",
        "org.bf2.cos.fleetshard.operator.it.camel.glues"
    })
@TestProfile(CamelConnectorReifyWithDefaultsTest.Profile.class)
public class CamelConnectorReifyWithDefaultsTest extends CucumberQuarkusTest {
