...
@CucumberOptions(
    features = {
        "classpath:CamelConnectorLifecycleStop.feature"
    },
    glue = {
        "org.bf2.cos.fleetshard.it.cucumber",
        "org.bf2.cos.fleetshard.operator.it.camel.glues"
    })
@TestProfile(CamelConnectorLifecycleStopTest.Profile.class)
public class CamelConnectorLifecycleStopTest extends CucumberQuarkusTest {
